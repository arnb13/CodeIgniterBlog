...
$routes->get('/home', 'Pages::show/home');
$routes->get('/about', 'Pages::show/about');
$routes->get('blog/create', 'Blog::create');
$routes->get('blog/updateBlog', 'Blog::updateBlog');
$routes->get('blog/deleteBlog', 'Blog::deleteBlog');
$routes->get('blog/(:any)', 'Blog::post/$1');
$routes->get('user/signup', 'User::signup');
$routes->get('user/login', 'User::login');
$routes->get('user/profile', 'User::profile');
$routes->get('user/updateProfile', 'User::updateProfile');
